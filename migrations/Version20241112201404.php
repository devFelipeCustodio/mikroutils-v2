 ...
 */
final class Version20241112201404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sessions (sess_id VARCHAR(128) NOT NULL, sess_data BYTEA NOT NULL, user_id INT, sess_lifetime INT NOT NULL, sess_time INT NOT NULL, PRIMARY KEY(sess_id))');
        ...
        $this->addSql('ALTER TABLE sessions ADD CONSTRAINT FK_sessions_user_id FOREIGN KEY (user_id) REFERENCES "user" (id)');
    }
